          ...
          <div className="w-full max-w-screen-2xl mx-auto flex flex-col md:flex-row items-center justify-between">
            <div className="w-full md:w-1/2 text-center mb-8 md:mb-0 pr-0 md:pr-8">
              ...
              <p className="text-xl md:text-3xl text-blue-400 mb-8">
                Please contact us on amazon to get this box as part of our tester group
              </p>
              
              {/* Instructions to contact via Amazon */}
              <div className="bg-white p-6 rounded-lg shadow-lg mb-6">
                <h2 className="text-2xl font-bold text-gray-800 mb-4">
                  How to Contact via Amazon
                </h2>
                <div className="text-left space-y-4">
                  ...
                  <ol className="list-decimal list-inside space-y-2 text-gray-700">
                    <li>Go to your Amazon account</li>
                    <li>Navigate to "Your Orders"</li>
                    <li>Find your Study Key product order</li>
                    <li>Click on "Get help with order"</li>
                    <li>Select "Contact seller"</li>
                    <li>Send us a message </li>
                  </ol>
                  <p className="text-lg text-gray-700 mt-4">
                    <strong>Note:</strong> Please include your Amazon order ID in your message for verification.
                  </p>
                </div>
              </div>
